...
This directory is the local standards index for `@sdkwork/membership-pc-membership`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/membership-pc-membership` |
| Type | `react-package` |
| Root | `sdkwork-membership/apps/sdkwork-membership-pc/packages/sdkwork-membership-pc-membership` |
| Domain | `commerce` |
