  ...
  return [
    {
      categoryLabel: "算力元",
      rows: [
        { benefitLabel: "平台免费算力元", values: ["每日登陆免费算力元", "每日登录赠送算力元", "每日登录赠送算力元", "每日登录赠送算力元", "每日登录赠送算力元"] },
        { benefitLabel: "充值购买算力元", values: [true, true, true, true, true] },
        { benefitLabel: "订阅会员算力元", values: ["-", "每月328算力元", "每月916算力元", "每月2,583算力元", "每月7,499算力元"] },
      ],
    },
    {
      categoryLabel: "视频生成",
      rows: [
        ...
        { benefitLabel: "seedance1.5 Pro模型", values: ["-", "8折算力元", "8折算力元", "8折算力元", "8折算力元"] },
