...
This directory is the local standards index for `@sdkwork/membership-pc-subscription`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/membership-pc-subscription` |
| Type | `react-package` |
| Root | `sdkwork-membership/apps/sdkwork-membership-pc/packages/sdkwork-membership-pc-subscription` |
| Domain | `commerce` |
