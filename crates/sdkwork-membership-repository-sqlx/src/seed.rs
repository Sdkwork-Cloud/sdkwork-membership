// NOTE: sdkwork_commerce_bootstrap_manifest was deleted
// Seed data functions are now defined locally in this module.
// TODO: Implement local seed data generation functions.

use sdkwork_contract_service::CommerceServiceError;
use sqlx::{PgPool, SqlitePool};

// Stub seed data functions (previously from sdkwork_commerce_bootstrap_manifest)
// These need to be implemented with actual seed data

fn commerce_benefit_definition_seeds() -> Vec<BenefitDefinitionSeed> { vec![] }
fn commerce_payment_channel_seeds() -> Vec<PaymentChannelSeed> { vec![] }
fn commerce_payment_method_seeds() -> Vec<CommercePaymentMethodSeed> { vec![] }
fn commerce_payment_provider_account_seeds() -> Vec<PaymentProviderAccountSeed> { vec![] }
fn commerce_payment_provider_seeds() -> Vec<PaymentProviderSeed> { vec![] }
fn commerce_payment_route_rule_seeds() -> Vec<PaymentRouteRuleSeed> { vec![] }
fn commerce_recharge_package_seeds() -> Vec<CommerceRechargePackageSeed> { vec![] }
fn commerce_recharge_settings_seeds() -> Vec<CommerceRechargeSettingsSeed> { vec![] }
fn membership_package_group_seeds() -> Vec<CommerceMembershipPackageGroupSeed> { vec![] }
fn membership_package_seeds() -> Vec<CommerceMembershipPackageSeed> { vec![] }
fn membership_plan_benefit_seeds() -> Vec<MembershipPlanBenefitSeed> { vec![] }
fn membership_plan_seeds() -> Vec<MembershipPlanSeed> { vec![] }
fn membership_plan_version_seeds() -> Vec<MembershipPlanVersionSeed> { vec![] }

// Stub seed data types
struct BenefitDefinitionSeed;
struct PaymentChannelSeed;
struct PaymentProviderAccountSeed;
struct PaymentProviderSeed;
struct PaymentRouteRuleSeed;
struct MembershipPlanBenefitSeed;
struct MembershipPlanSeed;
struct MembershipPlanVersionSeed;

// Re-exported types that are used in this file
struct CommerceMembershipPackageGroupSeed;
struct CommerceMembershipPackageSeed;
struct CommercePaymentMethodSeed;
struct CommerceRechargePackageSeed;
struct CommerceRechargeSettingsSeed;
