...
mod tests {
    ...
    async fn test_state() -> AdminMembershipState {
        // TODO: commerce_sqlite_memory_pool() was from deleted sdkwork-commerce-storage-repository-sqlx
        // Need to create local memory pool helper or use SqlitePool::connect("sqlite::memory:")
