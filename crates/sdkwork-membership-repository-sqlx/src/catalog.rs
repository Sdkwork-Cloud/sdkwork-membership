...
pub fn builtin_package_groups() -> Vec<AppMembershipPackageGroupItem> {
    vec![
        AppMembershipPackageGroupItem {
            id: 1,
            name: "连续包年".to_string(),
            description: Some("省25%".to_string()),
            sort_weight: 1,
            packages: vec![
                AppMembershipPackageItem {
                    ...
                    price: "648".to_string(),
                    original_price: Some("876".to_string()),
                    point_amount: 8700,
                    duration_days: 365,
                    plan_name: Some("基础会员".to_string()),
                    sort_weight: 1,
                    recommended: false,
                    tags: vec!["8折".to_string(), "每日24积分".to_string()],
                },
                AppMembershipPackageItem {
                    id: 102,
                    name: "标准会员·年卡".to_string(),
                    description: Some("连续包年，到期自动续费".to_string()),
                    price: "1998".to_string(),
                    original_price: Some("2652".to_string()),
                    point_amount: 26520,
                    duration_days: 365,
                    plan_name: Some("标准会员".to_string()),
                    sort_weight: 2,
                    recommended: true,
                    tags: vec!["7.5折".to_string(), "每日73积分".to_string()],
                },
                AppMembershipPackageItem {
                    id: 103,
                    name: "高级会员·年卡".to_string(),
                    description: Some("连续包年，到期自动续费".to_string()),
                    price: "5688".to_string(),
                    original_price: Some("7392".to_string()),
                    point_amount: 73920,
                    duration_days: 365,
                    plan_name: Some("高级会员".to_string()),
                    sort_weight: 3,
                    recommended: false,
                    tags: vec!["7.7折".to_string(), "每日202积分".to_string()],
                },
            ],
        },
        AppMembershipPackageGroupItem {
            id: 2,
            name: "连续包月".to_string(),
            description: Some("首月特惠".to_string()),
            sort_weight: 2,
            packages: vec![
                AppMembershipPackageItem {
                    id: 201,
                    ...
                    price: "68".to_string(),
                    original_price: Some("73".to_string()),
                    point_amount: 725,
                    duration_days: 30,
                    plan_name: Some("基础会员".to_string()),
                    sort_weight: 1,
                    recommended: false,
                    tags: vec!["首月60".to_string(), "每日24积分".to_string()],
                },
                AppMembershipPackageItem {
                    id: 202,
                    ...
                    description: Some("连续包月，到期自动续费".to_string()),
                    price: "198".to_string(),
                    original_price: Some("221".to_string()),
                    point_amount: 2210,
                    duration_days: 30,
                    plan_name: Some("标准会员".to_string()),
                    sort_weight: 2,
                    recommended: true,
                    tags: vec!["首月168".to_string(), "每日74积分".to_string()],
                },
                AppMembershipPackageItem {
                    id: 203,
                    ...
                    description: Some("连续包月，到期自动续费".to_string()),
                    price: "568".to_string(),
                    original_price: Some("616".to_string()),
                    point_amount: 6160,
                    duration_days: 30,
                    plan_name: Some("高级会员".to_string()),
                    sort_weight: 3,
                    recommended: false,
                    tags: vec!["首月498".to_string(), "每日205积分".to_string()],
                },
            ],
        },
        AppMembershipPackageGroupItem {
            id: 3,
            name: "连续包季".to_string(),
            description: Some("省15%".to_string()),
            sort_weight: 3,
            packages: vec![
                AppMembershipPackageItem {
                    id: 301,
                    ...
                    price: "188".to_string(),
                    original_price: Some("219".to_string()),
                    point_amount: 2175,
                    duration_days: 90,
                    plan_name: Some("基础会员".to_string()),
                    sort_weight: 1,
                    recommended: false,
                    tags: vec!["8.6折".to_string(), "每日24积分".to_string()],
                },
                AppMembershipPackageItem {
                    id: 302,
                    ...
                    description: Some("连续包季，到期自动续费".to_string()),
                    price: "548".to_string(),
                    original_price: Some("663".to_string()),
                    point_amount: 6630,
                    duration_days: 90,
                    plan_name: Some("标准会员".to_string()),
                    sort_weight: 2,
                    recommended: false,
                    tags: vec!["8.3折".to_string(), "每日74积分".to_string()],
                },
                AppMembershipPackageItem {
                    id: 303,
                    name: "高级会员·季卡".to_string(),
                    description: Some("连续包季，到期自动续费".to_string()),
                    price: "1588".to_string(),
                    original_price: Some("1848".to_string()),
                    point_amount: 18480,
                    duration_days: 90,
                    plan_name: Some("高级会员".to_string()),
                    sort_weight: 3,
                    recommended: false,
                    tags: vec!["8.6折".to_string(), "每日205积分".to_string()],
                },
            ],
        },
        AppMembershipPackageGroupItem {
