...
pub fn builtin_plans() -> Vec<AppMembershipPlanItem> {
    vec![
        AppMembershipPlanItem {
            ...
            description: Some("体验核心功能，每日赠送算力积分".to_string()),
            icon: None,
        ...
        AppMembershipPlanItem {
            ...
            description: Some("顶级VIP通道、最大配额与专属特效".to_string()),
            icon: None,
            badge: Some("至尊".to_string()),
        },
    ]
}
        ...
        AppMembershipPackageGroupItem {
            ...
            packages: vec![
                AppMembershipPackageItem {
                    ...
                    sort_weight: 1,
                    recommended: false,
                    tags: vec!["首年6折".to_string(), "11算力积分/天".to_string()],
                },
                AppMembershipPackageItem {
                    id: 102,
                    category: "token".to_string(),
                    ...
                    sort_weight: 2,
                    recommended: true,
                    tags: vec!["首年5.8折".to_string(), "30算力积分/天".to_string()],
                },
                AppMembershipPackageItem {
                    id: 103,
                    category: "token".to_string(),
                    ...
                    sort_weight: 3,
                    recommended: false,
                    tags: vec!["首年6折".to_string(), "85算力积分/天".to_string()],
                },
                AppMembershipPackageItem {
                    id: 104,
                    category: "token".to_string(),
                    ...
                    original_price: Some("12999".to_string()),
                    point_amount: 89990,
                    duration_days: 365,
                    plan_name: Some("超级会员".to_string()),
                    sort_weight: 4,
                    recommended: false,
                    tags: vec!["首年7折".to_string(), "247算力积分/天".to_string()],
                },
            ],
        },
        AppMembershipPackageGroupItem {
            ...
            packages: vec![
                AppMembershipPackageItem {
                    ...
                    sort_weight: 1,
                    recommended: false,
                    tags: vec!["6折".to_string(), "11算力积分/天".to_string()],
                },
                AppMembershipPackageItem {
                    id: 202,
                    category: "token".to_string(),
                    ...
                    sort_weight: 2,
                    recommended: true,
                    tags: vec!["6折".to_string(), "30算力积分/天".to_string()],
                },
                AppMembershipPackageItem {
                    id: 203,
                    category: "token".to_string(),
                    ...
                    sort_weight: 3,
                    recommended: false,
                    tags: vec!["6折".to_string(), "85算力积分/天".to_string()],
                },
                AppMembershipPackageItem {
                    id: 204,
                    category: "token".to_string(),
                    ...
                    description: Some("连续包月，到期自动续费".to_string()),
                    price: "750".to_string(),
                    original_price: Some("1083".to_string()),
                    point_amount: 7500,
                    duration_days: 30,
                    plan_name: Some("超级会员".to_string()),
                    sort_weight: 4,
                    recommended: false,
                    tags: vec!["7折".to_string(), "247算力积分/天".to_string()],
                },
            ],
        },
        AppMembershipPackageGroupItem {
            ...
            packages: vec![
                AppMembershipPackageItem {
                    ...
                    sort_weight: 1,
                    recommended: false,
                    tags: vec!["7折".to_string(), "11算力积分/天".to_string()],
                },
                AppMembershipPackageItem {
                    id: 302,
                    category: "token".to_string(),
                    ...
                    sort_weight: 2,
                    recommended: false,
                    tags: vec!["7折".to_string(), "30算力积分/天".to_string()],
                },
                AppMembershipPackageItem {
                    id: 303,
                    category: "token".to_string(),
                    ...
                    sort_weight: 3,
                    recommended: false,
                    tags: vec!["7折".to_string(), "85算力积分/天".to_string()],
                },
                AppMembershipPackageItem {
                    id: 304,
                    category: "token".to_string(),
                    ...
                    original_price: Some("3249".to_string()),
                    point_amount: 26250,
                    duration_days: 90,
                    plan_name: Some("超级会员".to_string()),
                    sort_weight: 4,
                    recommended: false,
                    tags: vec!["8折".to_string(), "247算力积分/天".to_string()],
                },
            ],
        },
        AppMembershipPackageGroupItem {
