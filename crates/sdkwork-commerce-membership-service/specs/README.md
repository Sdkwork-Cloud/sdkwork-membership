...
This directory is the local standards index for `sdkwork_commerce_membership_service`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-membership-service` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-membership-service` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
| Status | `stable` |
