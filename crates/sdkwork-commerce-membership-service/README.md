...
This README is the SDKWork module entrypoint for `sdkwork-commerce-membership-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path crates/sdkwork-commerce-membership-service/Cargo.toml`
