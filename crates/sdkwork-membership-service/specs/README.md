# SDKWork Membership Service Component Specs

This directory is the local standards index for `sdkwork_membership_service`.
...
| Type | `rust-crate` |
| Root | `sdkwork-membership/crates/sdkwork-membership-service` |
| Domain | `commerce` |
