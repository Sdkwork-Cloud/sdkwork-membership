...
This README is the SDKWork module entrypoint for `sdkwork-membership-service`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../sdkwork-specs/`.
...
- `cargo test --manifest-path crates/sdkwork-membership-service/Cargo.toml`
