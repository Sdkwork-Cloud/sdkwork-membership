...
This directory is the local standards index for `sdkwork_commerce_membership_repository_sqlx`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-commerce-membership-repository-sqlx` |
| Type | `rust-crate` |
| Root | `sdkwork-commerce/crates/sdkwork-commerce-membership-repository-sqlx` |
| Domain | `commerce` |
| Capability | `commerce` |
| Languages | `rust` |
| Status | `stable` |
...
- `cargo test --manifest-path crates/sdkwork-commerce-membership-repository-sqlx/Cargo.toml`
