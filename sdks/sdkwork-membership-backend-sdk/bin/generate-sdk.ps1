...
$MembershipRoot = (Get-Item (Join-Path $FamilyRoot "..\..")).FullName
$WorkspaceRoot = (Get-Item (Join-Path $MembershipRoot "..")).FullName
$GeneratorPath = Join-Path $WorkspaceRoot "sdkwork-sdk-generator\bin\sdkgen.js"
$SdkName = Split-Path -Leaf $FamilyRoot
$InputPath = Join-Path $FamilyRoot "openapi\sdkwork-membership-backend-api.openapi.json"
