...
test("PostgreSQL membership member detail and status update are organization scoped", () => {
  const source = fs.readFileSync(
    path.join(root, "crates/sdkwork-membership-repository-sqlx/src/postgres.rs"),
    "utf8",
  );
